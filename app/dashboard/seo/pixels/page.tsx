...
import { getAnalyticsSettings, upsertAnalyticsSettings } from './actions';
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
        ...
        <Button type="submit" className="w-full mt-4" disabled={loading}>{loading ? '...جارٍ الحفظ' : 'حفظ الإعدادات'}</Button>
      </form>
